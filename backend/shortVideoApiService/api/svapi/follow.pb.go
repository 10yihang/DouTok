...
const file_svapi_follow_proto_rawDesc = "" +
	"\n" +
	"\x12svapi/follow.proto\x12\x05svapi\x1a\x1cgoogle/api/annotations.proto\x1a\x1bbuf/validate/validate.proto\x1a\x10svapi/base.proto\"k\n" +
	"\n" +
	"FollowUser\x12\x0e\n" +
	...
	"\x04BOTH\x10\x022\x9d\x02\n" +
	"\rFollowService\x12R\n" +
	"\tAddFollow\x12\x17.svapi.AddFollowRequest\x1a\x18.svapi.AddFollowResponse\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\a/follow\x12[\n" +
	"\fRemoveFollow\x12\x1a.svapi.RemoveFollowRequest\x1a\x1b.svapi.RemoveFollowResponse\"\x12\x82\xd3\xe4\x93\x02\f:\x01**\a/follow\x12[\n" +
	"\rListFollowing\x12\x1b.svapi.ListFollowingRequest\x1a\x1c.svapi.ListFollowingResponse\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/followB)Z'github.com/cloudzenith/DouTok/...;svapib\x06proto3"

var (
	file_svapi_follow_proto_rawDescOnce sync.Once
	file_svapi_follow_proto_rawDescData []byte
)

func file_svapi_follow_proto_rawDescGZIP() []byte {
	file_svapi_follow_proto_rawDescOnce.Do(func() {
		file_svapi_follow_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_svapi_follow_proto_rawDesc), len(file_svapi_follow_proto_rawDesc)))
	})
...
func file_svapi_follow_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_svapi_follow_proto_rawDesc), len(file_svapi_follow_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
